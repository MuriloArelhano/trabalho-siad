...
#%%
db_dataframe_graph = final_dataframe.pivot(
    index='data', columns='cidade', values=['pop_casos_percent'])
db_dataframe_graph.plot(figsize=(15, 7), title='Porcentagem de infectados pela população', xlim=[
    datetime.date(2012, 1, 1), datetime.date(2016, 2, 1)], style='-o')
